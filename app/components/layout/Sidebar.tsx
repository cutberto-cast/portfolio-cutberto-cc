...
export default function Sidebar() {
    ...
    const liquidGlassStyle = `bg-black/40 backdrop-blur-xl border border-white/5 shadow-[inset_0_0_15px_rgba(255,255,255,0.05)] ${shapeStyle}`;
    ...
    return (
        <>
            <nav className="hidden lg:flex fixed left-6 top-1/2 -translate-y-1/2 z-50 flex-col gap-6">
                <div className={cn("relative flex flex-col gap-3 p-3 transition-all duration-300", liquidGlassStyle)}>
